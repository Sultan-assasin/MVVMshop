...
import com.sultan.mvvmshop.data.Order
import com.sultan.mvvmshop.data.OrderStatus
...
import com.sultan.mvvmshop.viewmodel.OrderViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonPlaceOrder.setOnClickListener {
            if (selectedAddress == null) {
                    Toast.makeText(
                        requireContext(), "Please select and address", Toast.LENGTH_SHORT
                    ).show()
